    ...
    def export_csv(self, request):
        ...
        for swipe in swipes:
            ...
            row = {
                ...
                "tags": snapshot.source_tags if snapshot else game.tags,
                ...
                "content_descriptor_notes": (raw_payload.get("content_descriptor_notes") if isinstance(raw_payload, dict) else "") or "",
